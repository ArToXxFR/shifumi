<div class="footer">
        ...
        <?php if (userConnected()) { ?>
                ...
                <button onclick="document.location.href='deconnection.php'" class="deconnection-button rouge-pastel"> <img class="icon-button" src="img/icon_exit.svg" alt="icon exit">Se déconnecter<img class="icon-button" src="img/fleche.svg" alt="flèche"></button>
        <?php } else { ?>
